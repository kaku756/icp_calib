...
def callback(data):
    ...
    transform_h3 = tf_buffer.lookup_transform(  "hand_link","camera3_depth_optical_frame",rospy.Time())  # 3B

    transform_wh = tf_buffer.lookup_transform( "workspace_link", "hand_link",rospy.Time())  # 3B
    ...
    pcd_transformed_h3 = do_transform_cloud(data, transform_h3)      #cam3 to hand crop this
    ...
    transform = tf_buffer.lookup_transform("camera3_depth_optical_frame", "camera3_link",rospy.Time())  # 3B
